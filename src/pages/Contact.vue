<template>
  <div class="max-w-4xl mx-auto px-6 py-12">
    ...
    <div 
      ref="ctaRef"
      class="bg-gradient-to-br from-blue-600 to-cyan-600 rounded-3xl p-10 text-center text-white relative overflow-hidden group transition-all duration-1000 transform"
