  ...
  <main class="max-w-4xl mx-auto px-4 sm:px-8 py-12">
    ...
    <article v-else class="fade-in">
      <header class="mb-12">
        ...
        <h1 class="text-4xl sm:text-5xl font-bold tracking-tight mb-4 text-gray-900 dark:text-white">{{ post.title }}</h1>
        <p class="text-xl text-gray-500 dark:text-gray-400 mb-8">{{ post.excerpt }}</p>
      ...
      <!-- Cover Image -->
      <div v-if="post.cover_image_url" class="mb-12 overflow-hidden rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm">
        <img 
