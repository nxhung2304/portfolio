...
- [x] Created bilingual CV templates (cv-en.html, cv-vi.html) with full content
- [x] Added real CV PDF (nxhung-cv.pdf) replacing placeholder
- [x] Updated About.vue download link to /nxhung-cv.pdf
- Source of content: static file in public/ (Option A)
